...
const segmentBox = document.getElementById("segment-container");
const hintText = document.getElementById("hint-display");
const wordContainer = document.getElementById("word-display");
const statusMessage = document.getElementById("message-display");
const virtualKeyboard = document.getElementById("keyboard");
const playAgainButton = document.getElementById("reset-btn");
const textGuessForm = document.getElementById("guess-form");
 ...
 */
function animateElementFade(elem) {
...
function createKeyboardKeys() {
    ...
    for (const btnNode of buttons) {
        const btn = btnNode; // 'as' is a type assertion
...
function processLetterGuess(letter) {
    ...
    const keyBtn = virtualKeyboard.querySelector(`[data-letter="${cleanLetter}"]`);
...
function finishGame(isWon) {
    ...
    const submitBtn = textGuessForm.querySelector("button");
    if (submitBtn) {
...
textGuessForm.addEventListener("submit", (e) => {
    e.preventDefault();
